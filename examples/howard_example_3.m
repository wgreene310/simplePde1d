...
%PDE2: MATLAB script M-ﬁle that solves the PDE
...
%EQN2: MATLAB M-ﬁle that contains the coeficents for
...
%BC2: MATLAB function M-ﬁle that deﬁnes boundary conditions
...
%INITIAL2: MATLAB function M-ﬁle that deﬁnes initial conditions

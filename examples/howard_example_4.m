...
%DEGSOLVE: MATLAB script M-ﬁle that solves the PDE
...
%PDEGWAVE: Function M-ﬁle that takes input x and returns
...
%DEGLINSYS: MATLAB M-ﬁle that contains the coeficents for
